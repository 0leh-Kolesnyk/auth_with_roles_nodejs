...
class authController {
	...
	async getUsers(req, res) {
		try {
			...
			// фрагмент кода удален после создания и сохранения в БД ролей админа и юзера
			...
			// res.json('server is working') // возвращаем на клиент какое-то сообщение
			// После этого данный фрагмент кода можно удалить.
